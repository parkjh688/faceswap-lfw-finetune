...
The fine-tuned model was trained on the LFW dataset (CPU environment). </br>
...
👉 Alternatively, you can directly download the pre-aligned version here: [Google Drive - LFW Aligned Dataset](https://drive.google.com/drive/folders/1xA7S2mwFZU1chJOUJb_69Q0lQ3Sa0uF9?usp=sharing)
